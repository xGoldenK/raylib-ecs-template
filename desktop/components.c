...
//--------------------------------------------------------------------------------------
//bool EntityHasComponent(char* id, ComponentType type) {
//	switch(type) {
//
//	case POSITION:
...
//}
//
//void* GetEntityComponent(char* id, ComponentType type) {
//	switch(type) {
//
//	case POSITION:
//		for(int i = 0; i < positions_lenght; i++) {
